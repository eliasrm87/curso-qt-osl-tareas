...
public:
    ...
    void setupUi(QMainWindow *MainWindow)
    {
        ...
        tblCateg->setHorizontalHeaderItem(0, __qtablewidgetitem5);
        QTableWidgetItem *__qtablewidgetitem6 = new QTableWidgetItem();
        tblCateg->setHorizontalHeaderItem(1, __qtablewidgetitem6);
        ...
        tblEtiq->setHorizontalHeaderItem(0, __qtablewidgetitem7);
    ...
    void retranslateUi(QMainWindow *MainWindow)
    {
        ...
        ___qtablewidgetitem4->setText(QApplication::translate("MainWindow", "Hecho", 0));
        TabTareas->setTabText(TabTareas->indexOf(tab), QApplication::translate("MainWindow", "Tareas", 0));
        QTableWidgetItem *___qtablewidgetitem5 = tblCateg->horizontalHeaderItem(0);
        ___qtablewidgetitem5->setText(QApplication::translate("MainWindow", "Categoria", 0));
        QTableWidgetItem *___qtablewidgetitem6 = tblCateg->horizontalHeaderItem(1);
        ...
        QTableWidgetItem *___qtablewidgetitem7 = tblEtiq->horizontalHeaderItem(0);
        ___qtablewidgetitem7->setText(QApplication::translate("MainWindow", "Etiqueta", 0));
